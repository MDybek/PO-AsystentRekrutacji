...
public class JwtService {
    ...
    public String generateToken(DaneUzytkownika userDetails) {
        return generateToken(new HashMap<>(), userDetails);
    }

    public String generateToken(Map<String, Object> extraClaims, DaneUzytkownika userDetails) {
        return Jwts
                .builder()
    ...
    public boolean isTokenValid(String token, DaneUzytkownika userDetails) {
